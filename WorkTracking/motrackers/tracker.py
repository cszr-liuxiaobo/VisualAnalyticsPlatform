...
class Tracker:
    ...
    def __init__(self, max_lost=100, tracker_output_format='mot_challenge'):
    ...
    def _add_track(self, frame_id, bbox, detection_confidence, class_id, **kwargs):
        ...
        """
        # tracks是一个字典，内部可以以next_track_id为键，增加相应的条目，提供给后续展示用。
        # next_track_id就是独特的obj-ID，每调用一次_add_track就增加一个。
