...
class YOLOv3(Detector):
    ...
    def __init__(self, weights_path, configfile_path, labels_path, confidence_threshold=0.3, nms_threshold=0.2, draw_bboxes=True, use_gpu=False):
    ...
    def detect(self, image):
        ...
        # print(cv.dnn.NMSBoxes(bboxes, confidences, self.confidence_threshold, self.nms_threshold).flatten())
