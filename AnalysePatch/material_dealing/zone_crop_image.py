...
if __name__ == '__main__':
    patch_number = 100
    # 注意改变数据集时文件夹要由train改成test
    train_folder="train"
    test_folder="test"

    "1concrete,2formwork,3rebar,4con_bar,5form_crete,6rebar_form"
    original_filpath="../../../PatchAnalyse-materials/construction_original_{}/4con_bar/".format(test_folder)
    filname=os.listdir(original_filpath)
    print(filname)
    for imagename in filname:
        crops_filpath = "../../../PatchAnalyse-materials/construction_crops/{}/4con_bar/".format(test_folder)+imagename
