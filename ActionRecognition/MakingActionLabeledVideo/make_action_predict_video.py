...
curr_dir = os.getcwd()
father_dir = os.path.dirname(curr_dir)
base_dir = os.path.dirname(father_dir)

video_name="NAVER1784_ch3_32249"
interval=30
classify_patch_path=father_dir+"/{}/classification/".format(video_name)
...
def make_video():
    ...
    fps = 30
    out=cv2.VideoWriter('./frames_tracking/tracking_predict_{}.avi'.format(video_name), fourcc, fps, size)
