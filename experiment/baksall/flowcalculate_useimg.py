...
def interval_opyval(mean):
    with open("./opticalvalue/opticalvalue_obj_{}.txt".format(obj_dir), "a")as f:
...
if __name__ == '__main__':
    ...
    dir_ori=base_path+"/dataprocessing/video_process/frames_ori/" \
                      "NAVER1784_ch3_20190831080000_20190831090000/allframes/"
    obj_dir_coors=base_path+"/dataprocessing/video_process/obj_{}_coors.txt".format(obj_dir)
    objs_pathes = base_path+"/dataprocessing/video_process/frames_patch_32249/" \
                            "NAVER1784_ch3_20190831080000_20190831090000/{}/".format(obj_dir)
